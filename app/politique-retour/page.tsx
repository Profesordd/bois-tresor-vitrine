  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
      ...
      <p className="text-gray-500 mb-10">
        Chez Bois Émeraude, votre satisfaction est une priorité. Si un produit ne vous convient pas,
      ...
      <div className="prose prose-gray max-w-none text-gray-700 space-y-8">
        ...
        <section>
          ...
          <p>Contactez-nous à contact@bois-emeraude.com avec votre numéro de commande et le détail du produit concerné ; nous vous indiquerons la marche à suivre.</p>
        </section>
        <section>
