    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="prose prose-gray max-w-none space-y-8 text-gray-700">
        <section>
          ...
          <p>Le site <strong>bois-emeraude.com</strong> est édité par Bois Émeraude.</p>
          <ul>
            <li>Email : contact@bois-emeraude.com</li>
          </ul>
        </section>

        <section>
          <h2 className="text-xl font-bold text-ink">2. Directeur de publication</h2>
          <p>Bois Émeraude — contact@bois-emeraude.com</p>
        </section>
        ...
        <section>
          ...
          <p>L&apos;ensemble des éléments du site (textes, images, graphismes, logo) est protégé par le droit de la propriété intellectuelle. Toute reproduction, même partielle, est interdite sans l&apos;accord préalable de Bois Émeraude.</p>
        </section>

        <section>
          <h2 className="text-xl font-bold text-ink">5. Responsabilité</h2>
          <p>Bois Émeraude s&apos;efforce de maintenir les informations du site à jour et exactes, sans garantie absolue d&apos;exhaustivité. Bois Émeraude ne saurait être tenu responsable des dommages résultant de l&apos;utilisation du site.</p>
        </section>
