    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="prose prose-gray max-w-none text-gray-700 space-y-8">
        {[
          ...
          { title: '5. Livraison', body: 'Les produits sont livrés à l’adresse indiquée par le Client, en France métropolitaine, en Belgique, en Suisse et au Luxembourg, par transporteur spécialisé, avec déchargement au plus près du lieu de stockage. La livraison est offerte sur toutes les commandes, sans montant minimum. Les délais indiqués sont donnés à titre approximatif.' },
