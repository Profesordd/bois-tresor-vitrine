...
export default function CgvPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
      ...
      <p className="text-gray-400 text-sm mb-10">Bois Émeraude</p>
      ...
      <div className="prose prose-gray max-w-none text-gray-700 space-y-8">
        {[
          ...
          { title: '2. Prix', body: 'Les prix sont indiqués en euros toutes taxes comprises (TTC). Sauf mention contraire sur la fiche produit, la livraison est incluse. Bois Émeraude se réserve le droit de modifier ses prix à tout moment ; le Client est facturé sur la base du tarif en vigueur au moment de la confirmation de la commande.' },
          ...
          { title: '4. Paiement', body: 'Le paiement s’effectue en ligne par carte bancaire (CB, Visa, Mastercard) via une plateforme bancaire certifiée PCI-DSS, avec authentification 3D-Secure. Bois Émeraude n’a jamais accès aux informations de carte bancaire.' },
          { title: '5. Livraison', body: 'Les produits sont livrés à l’adresse indiquée par le Client, partout en France métropolitaine, par transporteur spécialisé, avec déchargement au plus près du lieu de stockage. Les délais indiqués sont donnés à titre approximatif.' },
