    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="prose prose-gray max-w-none text-gray-700 space-y-8">
        {[
          ...
          { title: '2. Prix', body: 'Les prix sont indiqués en euros toutes taxes comprises (TTC). Sauf mention contraire sur la fiche produit, la livraison est incluse. Bois Tresor se réserve le droit de modifier ses prix à tout moment ; le Client est facturé sur la base du tarif en vigueur au moment de la confirmation de la commande.' },
